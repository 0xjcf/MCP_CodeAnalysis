...
describe('Response Utilities', () => {
  describe('createSuccessResponse', () => {
    ...
    it('should calculate execution time when provided', () => {
      ...
      // Allow a small variation in the execution time (it's 101 in the error)
      expect(response.metadata.executionTime).toBeGreaterThanOrEqual(99);
      expect(response.metadata.executionTime).toBeLessThanOrEqual(101);
    });
  });
